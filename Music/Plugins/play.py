...
@Client.on_message(command(["/play", "ايطالي" ,"كابوس جيزه" ,"جاميكا" ,"شغل" ,"تشغيل", f"/play@{BOT_USERNAME}", "تشغيل"]))
...
`تشغيل او شغل او ايطالي + أسم المقطع الصوتي 🎧`
""",
            )
            return
        what = "Query Given"
